import { CreateEditorViewOptions, ProsemirrorService } from '@vendure/admin-ui/core';
 ...
 */
export declare const useRichTextEditor: ({ attributes, onTextInput, isReadOnly }: useRichTextEditorOptions) => {
    ref: import("react").RefObject<HTMLDivElement>;
    editor: ProsemirrorService;
};
