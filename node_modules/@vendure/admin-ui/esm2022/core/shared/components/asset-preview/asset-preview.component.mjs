...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "17.2.4", ngImport: i0, type: AssetPreviewComponent, decorators: [{
        ...
        }], ctorParameters: () => [{ type: i1.FormBuilder }, { type: i2.DataService }, { type: i3.NotificationService }, { type: i0.ChangeDetectorRef }, { type: i4.ModalService }], propDecorators: { asset: [{
                type: Input
            }], assets: [{
                type: Input
            }], editable: [{
