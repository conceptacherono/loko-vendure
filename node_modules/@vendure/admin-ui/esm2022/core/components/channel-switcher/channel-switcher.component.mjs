...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "17.2.4", ngImport: i0, type: ChannelSwitcherComponent, decorators: [{
        ...
        }], ctorParameters: () => [{ type: i1.DataService }, { type: i2.ChannelService }] });
