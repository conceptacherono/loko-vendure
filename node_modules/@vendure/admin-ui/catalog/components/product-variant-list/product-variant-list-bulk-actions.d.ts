...
export declare const deleteProductVariantsBulkAction: BulkAction<ProductVariant, ProductVariantListComponent>;
export declare const assignFacetValuesToProductVariantsBulkAction: BulkAction<ItemOf<GetProductVariantListQuery, 'productVariants'>, ProductVariantListComponent>;
