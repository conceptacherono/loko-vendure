...
import * as i3 from "./components/facet-list/facet-list.component";
import * as i4 from "./components/facet-detail/facet-detail.component";
...
import * as i13 from "./components/collection-tree/collection-tree-node.component";
import * as i14 from "./components/collection-contents/collection-contents.component";
import * as i15 from "./components/product-variants-table/product-variants-table.component";
import * as i16 from "./components/option-value-input/option-value-input.component";
import * as i17 from "./components/update-product-option-dialog/update-product-option-dialog.component";
import * as i18 from "./components/product-variants-editor/product-variants-editor.component";
import * as i19 from "./components/assign-products-to-channel-dialog/assign-products-to-channel-dialog.component";
import * as i20 from "./components/asset-detail/asset-detail.component";
import * as i21 from "./components/confirm-variant-deletion-dialog/confirm-variant-deletion-dialog.component";
import * as i22 from "./components/product-options-editor/product-options-editor.component";
import * as i23 from "./components/bulk-add-facet-values-dialog/bulk-add-facet-values-dialog.component";
import * as i24 from "./components/collection-data-table/collection-data-table.component";
import * as i25 from "./components/collection-list/collection-breadcrumb.pipe";
import * as i26 from "./components/move-collections-dialog/move-collections-dialog.component";
import * as i27 from "./components/product-variant-list/product-variant-list.component";
import * as i28 from "./components/product-variant-detail/product-variant-detail.component";
