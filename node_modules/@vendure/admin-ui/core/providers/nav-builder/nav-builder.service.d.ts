...
import { ActionBarContext, ActionBarDropdownMenuItem, ActionBarItem, NavMenuBadgeType, NavMenuItem, NavMenuSection, RouterLinkDefinition } from './nav-builder-types';
...
export declare class NavBuilderService {
    ...
    private addedActionBarDropdownMenuItems;
    constructor();
    /**
     ...
     * `data-location-id` attribute.
     */
    addActionBarDropdownMenuItem(config: ActionBarDropdownMenuItem): void;
