...
export declare const FULFILLMENT_FRAGMENT: import("apollo-angular").TypedDocumentNode<unknown, unknown>;
export declare const PAYMENT_WITH_REFUNDS_FRAGMENT: import("apollo-angular").TypedDocumentNode<unknown, unknown>;
export declare const ORDER_LINE_FRAGMENT: import("apollo-angular").TypedDocumentNode<unknown, unknown>;
export declare const ORDER_DETAIL_FRAGMENT: import("apollo-angular").TypedDocumentNode<unknown, unknown>;
...
export declare const REFUND_ORDER: import("apollo-angular").TypedDocumentNode<unknown, unknown>;
export declare const SETTLE_REFUND: import("apollo-angular").TypedDocumentNode<unknown, unknown>;
export declare const GET_ORDER_HISTORY: import("apollo-angular").TypedDocumentNode<unknown, unknown>;
export declare const ADD_NOTE_TO_ORDER: import("apollo-angular").TypedDocumentNode<unknown, unknown>;
export declare const UPDATE_ORDER_NOTE: import("apollo-angular").TypedDocumentNode<unknown, unknown>;
export declare const DELETE_ORDER_NOTE: import("apollo-angular").TypedDocumentNode<unknown, unknown>;
export declare const TRANSITION_ORDER_TO_STATE: import("apollo-angular").TypedDocumentNode<unknown, unknown>;
export declare const UPDATE_ORDER_CUSTOM_FIELDS: import("apollo-angular").TypedDocumentNode<unknown, unknown>;
export declare const TRANSITION_FULFILLMENT_TO_STATE: import("apollo-angular").TypedDocumentNode<unknown, unknown>;
