...
import { CustomFieldConfig, CustomFields, GetGlobalSettingsQuery, GetServerConfigQuery, OrderProcessState, PermissionDefinition } from '../common/generated-types';
...
export declare class ServerConfigService {
     ...
     */
    refreshGlobalSettings(): import("rxjs").Observable<GetGlobalSettingsQuery>;
    /**
