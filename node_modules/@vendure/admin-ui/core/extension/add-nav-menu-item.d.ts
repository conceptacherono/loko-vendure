 ...
 */
export declare function addNavMenuSection(config: NavMenuSection, before?: string): import("@angular/core").EnvironmentProviders;
/**
 * @description
 ...
 * @docsCategory nav-menu
 */
export declare function addNavMenuItem(config: NavMenuItem, sectionId: string, before?: string): import("@angular/core").EnvironmentProviders;
