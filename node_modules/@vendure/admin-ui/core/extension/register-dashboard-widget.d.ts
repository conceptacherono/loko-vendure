 ...
 */
export declare function registerDashboardWidget(id: string, config: DashboardWidgetConfig): import("@angular/core").EnvironmentProviders;
/**
 * @description
 ...
 * @docsCategory dashboard-widgets
 */
export declare function setDashboardWidgetLayout(layoutDef: WidgetLayoutDefinition): import("@angular/core").EnvironmentProviders;
