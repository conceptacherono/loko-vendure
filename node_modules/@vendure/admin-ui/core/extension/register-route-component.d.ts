...
export declare function registerRouteComponent<Component extends any | BaseDetailComponent<Entity>, Entity extends {
    ...
    title?: string | Type<import("@angular/router").Resolve<string>> | ResolveFn<string>;
    path: string;
    pathMatch?: "prefix" | "full";
    matcher?: import("@angular/router").UrlMatcher;
    loadComponent?: () => Type<unknown> | Observable<Type<unknown> | import("@angular/router").DefaultExport<Type<unknown>>> | Promise<Type<unknown> | import("@angular/router").DefaultExport<Type<unknown>>>;
    redirectTo?: string | import("@angular/router").RedirectFunction;
    outlet?: string;
    canActivate?: Array<import("@angular/router").CanActivateFn | import("@angular/router").DeprecatedGuard>;
    canMatch?: Array<import("@angular/router").CanMatchFn | import("@angular/router").DeprecatedGuard>;
    canActivateChild?: Array<import("@angular/router").CanActivateChildFn | import("@angular/router").DeprecatedGuard>;
    canDeactivate?: Array<import("@angular/router").CanDeactivateFn<any> | import("@angular/router").DeprecatedGuard>;
    canLoad?: Array<import("@angular/router").CanLoadFn | import("@angular/router").DeprecatedGuard>;
    children?: import("@angular/router").Routes;
    loadChildren?: import("@angular/router").LoadChildren;
    runGuardsAndResolvers?: import("@angular/router").RunGuardsAndResolvers;
    providers: Array<import("@angular/core").Provider | import("@angular/core").EnvironmentProviders>;
};
