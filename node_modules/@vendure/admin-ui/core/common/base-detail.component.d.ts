...
export declare abstract class BaseDetailComponent<Entity extends {
    ...
    protected constructor(route: ActivatedRoute, router: Router, serverConfigService: ServerConfigService, dataService: DataService, permissionsService: PermissionsService);
    init(): void;
