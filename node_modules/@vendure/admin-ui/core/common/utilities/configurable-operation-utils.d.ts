 ...
 */
export declare function configurableDefinitionToInstance(def: Omit<ConfigurableOperationDefinition, '__typename'>): ConfigurableOperation;
/**
 ...
 * ```
 */
export declare function toConfigurableOperationInput(operation: Omit<ConfigurableOperation, '__typename'>, formValueOperations: {
