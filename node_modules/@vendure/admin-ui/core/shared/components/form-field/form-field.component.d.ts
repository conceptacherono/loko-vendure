...
export declare class FormFieldComponent implements OnInit {
    ...
    readOnlyToggleChange: EventEmitter<boolean>;
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<FormFieldComponent, "vdr-form-field", never, { "label": { "alias": "label"; "required": false; }; "for": { "alias": "for"; "required": false; }; "tooltip": { "alias": "tooltip"; "required": false; }; "errors": { "alias": "errors"; "required": false; }; "readOnlyToggle": { "alias": "readOnlyToggle"; "required": false; }; }, { "readOnlyToggleChange": "readOnlyToggleChange"; }, ["formFieldControl"], ["*"], false, never>;
}
