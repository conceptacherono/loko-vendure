...
export declare class AssignToChannelDialogComponent implements OnInit, Dialog<Channel[]> {
    ...
    selectedChannelIdControl: UntypedFormControl;
    itemNames: string;
    nMore: number;
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<AssignToChannelDialogComponent, "vdr-assign-to-channel-dialog", never, {}, {}, never, never, false, never>;
}
export {};
