...
export declare class DataTableComponent<T> implements AfterContentInit, OnChanges, OnInit, OnDestroy {
    ...
    allSelected: boolean;
    /** @deprecated pass a SelectionManager instance instead */
    isRowSelectedFn: ((item: T) => boolean) | undefined;
    /** @deprecated pass a SelectionManager instance instead */
