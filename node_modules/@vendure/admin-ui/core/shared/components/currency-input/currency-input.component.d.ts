...
export declare class CurrencyInputComponent implements ControlValueAccessor, OnInit, OnChanges, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<CurrencyInputComponent, "vdr-currency-input", never, { "disabled": { "alias": "disabled"; "required": false; }; "readonly": { "alias": "readonly"; "required": false; }; "value": { "alias": "value"; "required": false; }; "currencyCode": { "alias": "currencyCode"; "required": false; }; }, { "valueChange": "valueChange"; }, never, never, false, never>;
}
