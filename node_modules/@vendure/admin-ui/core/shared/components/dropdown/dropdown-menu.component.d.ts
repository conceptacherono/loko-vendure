...
export declare class DropdownMenuComponent implements AfterViewInit, OnInit, OnDestroy {
    ...
    constructor(overlay: Overlay, viewContainerRef: ViewContainerRef, dropdown: DropdownComponent, localizationService: LocalizationService, changeDetector: ChangeDetectorRef);
    ngOnInit(): void;
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<DropdownMenuComponent, "vdr-dropdown-menu", never, { "position": { "alias": "vdrPosition"; "required": false; }; "customClasses": { "alias": "customClasses"; "required": false; }; }, {}, never, ["*"], false, never>;
}
