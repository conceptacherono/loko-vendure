...
let globalColorBlue25 = UIColor(red: 235, green: 249, blue: 255, alpha: 1.0);
...
let globalTypographyFontWeightSemibold = "600";
let globalTypographyFontWeightBold = "600";
let globalTypographyFontWeightExtrabold = "600";
...
let globalTypographyBodyLetterSpacing = "-0.00714286em";
...
let globalTypographyTitleLineHeight = "1.333333em";
let globalTypographyTitleLetterSpacing = "-0.00833333em";
...
let globalTypographySubsectionLineHeight = "1.5em";
...
let globalTypographyMessageLineHeight = "1.5em";
...
let aliasObjectShadow100 = "0 calc((1 / var(--cds-global-base, 20)) * 1rem) calc((3 / var(--cds-global-base, 20)) * 1rem) 0 hsla(198, 30%, 15%, 0.5)";
let aliasObjectShadow200 = "0 calc((1 / var(--cds-global-base, 20)) * 1rem) calc((3 / var(--cds-global-base, 20)) * 1rem) 0 hsla(198, 30%, 15%, 0.3)";
let aliasObjectShadow300 = "0 calc((1 / var(--cds-global-base, 20)) * 1rem) calc((3 / var(--cds-global-base, 20)) * 1rem) 0 hsla(198, 30%, 15%, 0.2)";
...
let aliasObjectInteractionBackgroundShade = UIColor(red: 243, green: 245, blue: 247, alpha: 1.0);
let aliasObjectInteractionBackgroundShadeHover = UIColor(red: 227, green: 234, blue: 237, alpha: 1.0);
let aliasObjectInteractionBackgroundShadeActive = UIColor(red: 224, green: 246, blue: 255, alpha: 1.0);
let aliasObjectInteractionBackgroundShadeSelected = UIColor(red: 255, green: 255, blue: 255, alpha: 1.0);
let aliasObjectInteractionBackgroundShadeSelectedHover = UIColor(red: 227, green: 234, blue: 237, alpha: 1.0);
let aliasObjectInteractionBackgroundShadeSelectedActive = UIColor(red: 203, green: 212, blue: 216, alpha: 1.0);
...
let aliasObjectInteractionInfoHover = UIColor(red: 0, green: 96, blue: 138, alpha: 1.0);
let aliasObjectInteractionInfoClick = UIColor(red: 0, green: 75, blue: 107, alpha: 1.0);
let aliasObjectInteractionInfoActive = UIColor(red: 0, green: 75, blue: 107, alpha: 1.0);
let aliasObjectInteractionInfoSelected = UIColor(red: 0, green: 75, blue: 107, alpha: 1.0);
let aliasObjectInteractionInfoSecondaryHover = UIColor(red: 229, green: 247, blue: 255, alpha: 1.0);
let aliasObjectInteractionSuccessHover = UIColor(red: 54, green: 106, blue: 12, alpha: 1.0);
let aliasObjectInteractionSuccessClick = UIColor(red: 40, green: 78, blue: 9, alpha: 1.0);
let aliasObjectInteractionSuccessActive = UIColor(red: 40, green: 78, blue: 9, alpha: 1.0);
let aliasObjectInteractionSuccessSecondaryHover = UIColor(red: 238, green: 252, blue: 227, alpha: 1.0);
let aliasObjectInteractionWarningHover = UIColor(red: 255, green: 166, blue: 0, alpha: 1.0);
let aliasObjectInteractionWarningClick = UIColor(red: 40, green: 78, blue: 9, alpha: 1.0);
let aliasObjectInteractionWarningActive = UIColor(red: 40, green: 78, blue: 9, alpha: 1.0);
...
let aliasObjectInteractionDangerActive = UIColor(red: 143, green: 21, blue: 0, alpha: 1.0);
...
let aliasObjectInteractionNeutralActive = UIColor(red: 45, green: 64, blue: 72, alpha: 1.0);
let aliasObjectInteractionNeutralSecondaryHover = UIColor(red: 241, green: 246, blue: 248, alpha: 1.0);
let aliasObjectInteractionInverseHover = UIColor(red: 79, green: 97, blue: 105, alpha: 1.0);
let aliasObjectInteractionInverseClick = UIColor(red: 45, green: 64, blue: 72, alpha: 1.0);
let aliasObjectInteractionInverseActive = UIColor(red: 45, green: 64, blue: 72, alpha: 1.0);
...
let aliasObjectContainerBackgroundDark = UIColor(red: 243, green: 245, blue: 247, alpha: 1.0);
let aliasObjectContainerBackgroundInverse = UIColor(red: 79, green: 97, blue: 105, alpha: 1.0);
let aliasObjectContainerBackgroundInverseTint = UIColor(red: 45, green: 64, blue: 72, alpha: 1.0);
let aliasObjectContainerBackgroundInverseShade = UIColor(red: 106, green: 122, blue: 129, alpha: 1.0);
...
let aliasUtilityGray = UIColor(red: 79, green: 97, blue: 105, alpha: 1.0);
...
let aliasVizSeverityWarningLight = UIColor(red: 255, green: 198, blue: 10, alpha: 1.0);
let aliasVizSeverityImmediate = UIColor(red: 255, green: 142, blue: 61, alpha: 1.0);
let aliasVizSeverityCritical = UIColor(red: 224, green: 34, blue: 0, alpha: 1.0);
let aliasVizSeverityFreeSpaceFill = UIColor(red: 227, green: 234, blue: 237, alpha: 1.0);
let aliasVizSeverityFreeSpaceBorder = UIColor(red: 133, green: 147, blue: 153, alpha: 1.0);
...
let aliasVizDivergingVioletAquaV200 = UIColor(red: 224, green: 180, blue: 243, alpha: 1.0);
let aliasVizDivergingVioletAquaV300 = UIColor(red: 206, green: 145, blue: 232, alpha: 1.0);
let aliasVizDivergingVioletAquaV400 = UIColor(red: 187, green: 112, blue: 219, alpha: 1.0);
let aliasVizDivergingVioletAquaV500 = UIColor(red: 172, green: 80, blue: 211, alpha: 1.0);
let aliasVizDivergingVioletAquaV600 = UIColor(red: 155, green: 50, blue: 200, alpha: 1.0);
let aliasVizDivergingVioletAquaV700 = UIColor(red: 124, green: 18, blue: 165, alpha: 1.0);
let aliasVizDivergingVioletAquaNeutral = UIColor(red: 250, green: 240, blue: 255, alpha: 1.0);
let aliasVizDivergingVioletAquaA400 = UIColor(red: 0, green: 228, blue: 245, alpha: 1.0);
let aliasVizDivergingVioletAquaA500 = UIColor(red: 0, green: 205, blue: 219, alpha: 1.0);
let aliasVizDivergingVioletAquaA600 = UIColor(red: 0, green: 162, blue: 173, alpha: 1.0);
let aliasVizDivergingVioletAquaA700 = UIColor(red: 0, green: 119, blue: 128, alpha: 1.0);
let aliasVizDivergingVioletAquaA800 = UIColor(red: 0, green: 86, blue: 92, alpha: 1.0);
let aliasVizDivergingVioletAquaA900 = UIColor(red: 0, green: 62, blue: 66, alpha: 1.0);
let aliasVizDivergingBlueJadeB300 = UIColor(red: 102, green: 209, blue: 255, alpha: 1.0);
let aliasVizDivergingBlueJadeB400 = UIColor(red: 46, green: 192, blue: 255, alpha: 1.0);
let aliasVizDivergingBlueJadeB500 = UIColor(red: 0, green: 171, blue: 245, alpha: 1.0);
let aliasVizDivergingBlueJadeB600 = UIColor(red: 0, green: 154, blue: 219, alpha: 1.0);
let aliasVizDivergingBlueJadeB700 = UIColor(red: 0, green: 121, blue: 173, alpha: 1.0);
let aliasVizDivergingBlueJadeB800 = UIColor(red: 0, green: 96, blue: 138, alpha: 1.0);
let aliasVizDivergingBlueJadeNeutral = UIColor(red: 229, green: 247, blue: 255, alpha: 1.0);
let aliasVizDivergingBlueJadeJ300 = UIColor(red: 104, green: 227, blue: 186, alpha: 1.0);
let aliasVizDivergingBlueJadeJ400 = UIColor(red: 52, green: 218, blue: 163, alpha: 1.0);
let aliasVizDivergingBlueJadeJ500 = UIColor(red: 41, green: 188, blue: 139, alpha: 1.0);
let aliasVizDivergingBlueJadeJ600 = UIColor(red: 28, green: 155, blue: 113, alpha: 1.0);
let aliasVizDivergingBlueJadeJ700 = UIColor(red: 28, green: 125, blue: 93, alpha: 1.0);
let aliasVizDivergingBlueJadeJ800 = UIColor(red: 0, green: 107, blue: 71, alpha: 1.0);
let aliasVizDivergingBlueGreenB300 = UIColor(red: 102, green: 209, blue: 255, alpha: 1.0);
let aliasVizDivergingBlueGreenB400 = UIColor(red: 46, green: 192, blue: 255, alpha: 1.0);
let aliasVizDivergingBlueGreenB500 = UIColor(red: 0, green: 171, blue: 245, alpha: 1.0);
let aliasVizDivergingBlueGreenB600 = UIColor(red: 0, green: 154, blue: 219, alpha: 1.0);
let aliasVizDivergingBlueGreenB700 = UIColor(red: 0, green: 121, blue: 173, alpha: 1.0);
let aliasVizDivergingBlueGreenB800 = UIColor(red: 0, green: 96, blue: 138, alpha: 1.0);
let aliasVizDivergingBlueGreenNeutral = UIColor(red: 229, green: 247, blue: 255, alpha: 1.0);
let aliasVizDivergingBlueGreenG300 = UIColor(red: 134, green: 233, blue: 53, alpha: 1.0);
let aliasVizDivergingBlueGreenG400 = UIColor(red: 113, green: 220, blue: 24, alpha: 1.0);
let aliasVizDivergingBlueGreenG500 = UIColor(red: 103, green: 202, blue: 22, alpha: 1.0);
let aliasVizDivergingBlueGreenG600 = UIColor(red: 87, green: 170, blue: 19, alpha: 1.0);
let aliasVizDivergingBlueGreenG700 = UIColor(red: 66, green: 129, blue: 14, alpha: 1.0);
let aliasVizDivergingBlueGreenG800 = UIColor(red: 54, green: 106, blue: 12, alpha: 1.0);
let aliasVizDivergingGreenYellowRedG200 = UIColor(red: 172, green: 240, blue: 117, alpha: 1.0);
let aliasVizDivergingGreenYellowRedG300 = UIColor(red: 134, green: 233, blue: 53, alpha: 1.0);
let aliasVizDivergingGreenYellowRedG400 = UIColor(red: 113, green: 220, blue: 24, alpha: 1.0);
let aliasVizDivergingGreenYellowRedG500 = UIColor(red: 103, green: 202, blue: 22, alpha: 1.0);
let aliasVizDivergingGreenYellowRedG600 = UIColor(red: 87, green: 170, blue: 19, alpha: 1.0);
let aliasVizDivergingGreenYellowRedG700 = UIColor(red: 66, green: 129, blue: 14, alpha: 1.0);
let aliasVizDivergingGreenYellowRedNeutral = UIColor(red: 255, green: 232, blue: 117, alpha: 1.0);
let aliasVizDivergingGreenYellowRedR400 = UIColor(red: 255, green: 129, blue: 107, alpha: 1.0);
let aliasVizDivergingGreenYellowRedR500 = UIColor(red: 255, green: 103, blue: 77, alpha: 1.0);
let aliasVizDivergingGreenYellowRedR600 = UIColor(red: 255, green: 77, blue: 46, alpha: 1.0);
let aliasVizDivergingGreenYellowRedR700 = UIColor(red: 224, green: 34, blue: 0, alpha: 1.0);
let aliasVizDivergingGreenYellowRedR800 = UIColor(red: 194, green: 29, blue: 0, alpha: 1.0);
let aliasVizDivergingGreenYellowRedR900 = UIColor(red: 143, green: 21, blue: 0, alpha: 1.0);
...
let aliasTypographyBodyLetterSpacing = "-0.00714286em";
...
let aliasTypographyTitleLineHeight = "1.333333em";
let aliasTypographyTitleLetterSpacing = "-0.00833333em";
...
let aliasTypographySubsectionLineHeight = "1.5em";
...
let aliasTypographyMessageLineHeight = "1.5em";
